...
export default class SolidityParser extends Parser {
	...
	public sourceUnit(): SourceUnitContext {
		...
		try {
			...
			while ((((_la) & ~0x1F) === 0 && ((1 << _la) & 406609922) !== 0) || ((((_la - 38)) & ~0x1F) === 0 && ((1 << (_la - 38)) & 2080392501) !== 0) || ((((_la - 97)) & ~0x1F) === 0 && ((1 << (_la - 97)) & 3498573949) !== 0) || ((((_la - 129)) & ~0x1F) === 0 && ((1 << (_la - 129)) & 7) !== 0)) {
				{
				this.state = 215;
				this._errHandler.sync(this);
	...
	public contractDefinition(): ContractDefinitionContext {
		...
		try {
			...
			this._errHandler.sync(this);
			_la = this._input.LA(1);
			while ((((_la) & ~0x1F) === 0 && ((1 << _la) & 402669568) !== 0) || ((((_la - 38)) & ~0x1F) === 0 && ((1 << (_la - 38)) & 2080392503) !== 0) || ((((_la - 97)) & ~0x1F) === 0 && ((1 << (_la - 97)) & 3498573949) !== 0) || ((((_la - 129)) & ~0x1F) === 0 && ((1 << (_la - 129)) & 7) !== 0)) {
				{
				{
				this.state = 324;
				this.contractPart();
	...
	public inheritanceSpecifier(): InheritanceSpecifierContext {
		...
		try {
			...
			if (_la===23) {
				...
				this._errHandler.sync(this);
				_la = this._input.LA(1);
				if (((((_la - 6)) & ~0x1F) === 0 && ((1 << (_la - 6)) & 203555073) !== 0) || ((((_la - 40)) & ~0x1F) === 0 && ((1 << (_la - 40)) & 4278194513) !== 0) || ((((_la - 73)) & ~0x1F) === 0 && ((1 << (_la - 73)) & 4244635651) !== 0) || ((((_la - 105)) & ~0x1F) === 0 && ((1 << (_la - 105)) & 248547339) !== 0)) {
					{
					this.state = 334;
					this.expressionList();
					}
	...
	public structDefinition(): StructDefinitionContext {
		...
		try {
			...
			this._errHandler.sync(this);
			_la = this._input.LA(1);
			if (_la===14 || _la===27 || ((((_la - 40)) & ~0x1F) === 0 && ((1 << (_la - 40)) & 520098113) !== 0) || ((((_la - 97)) & ~0x1F) === 0 && ((1 << (_la - 97)) & 3230138493) !== 0) || _la===130 || _la===131) {
				{
				this.state = 429;
				...
				this._errHandler.sync(this);
				_la = this._input.LA(1);
				while (_la===14 || _la===27 || ((((_la - 40)) & ~0x1F) === 0 && ((1 << (_la - 40)) & 520098113) !== 0) || ((((_la - 97)) & ~0x1F) === 0 && ((1 << (_la - 97)) & 3230138493) !== 0) || _la===130 || _la===131) {
					{
					{
					this.state = 431;
					this.variableDeclaration();
	...
	public functionDescriptor(): FunctionDescriptorContext {
		...
		try {
			...
			case 40:
				...
				this._errHandler.sync(this);
				_la = this._input.LA(1);
				if (_la===14 || _la===27 || ((((_la - 46)) & ~0x1F) === 0 && ((1 << (_la - 46)) & 262209) !== 0) || ((((_la - 97)) & ~0x1F) === 0 && ((1 << (_la - 97)) & 3230138369) !== 0) || _la===130 || _la===131) {
					{
					this.state = 478;
					this.identifier();
					}
	...
	public modifierList(): ModifierListContext {
		...
		try {
			...
			this._errHandler.sync(this);
			_la = this._input.LA(1);
			while (_la===14 || _la===27 || ((((_la - 46)) & ~0x1F) === 0 && ((1 << (_la - 46)) & 262209) !== 0) || ((((_la - 97)) & ~0x1F) === 0 && ((1 << (_la - 97)) & 4023943171) !== 0) || _la===130 || _la===131) {
				{
				this.state = 497;
				this._errHandler.sync(this);
	...
	public block(): BlockContext {
		...
		try {
			...
			this._errHandler.sync(this);
			_la = this._input.LA(1);
			while (((((_la - 6)) & ~0x1F) === 0 && ((1 << (_la - 6)) & 211944193) !== 0) || ((((_la - 40)) & ~0x1F) === 0 && ((1 << (_la - 40)) & 4294881617) !== 0) || ((((_la - 73)) & ~0x1F) === 0 && ((1 << (_la - 73)) & 4244635651) !== 0) || ((((_la - 105)) & ~0x1F) === 0 && ((1 << (_la - 105)) & 248548427) !== 0)) {
				{
				{
				this.state = 658;
				this.statement();
	...
	public catchClause(): CatchClauseContext {
		...
		try {
			...
			this._errHandler.sync(this);
			_la = this._input.LA(1);
			if ((((_la) & ~0x1F) === 0 && ((1 << _la) & 142622720) !== 0) || ((((_la - 46)) & ~0x1F) === 0 && ((1 << (_la - 46)) & 262209) !== 0) || ((((_la - 97)) & ~0x1F) === 0 && ((1 << (_la - 97)) & 3230138369) !== 0) || _la===130 || _la===131) {
				{
				this.state = 708;
				this._errHandler.sync(this);
				_la = this._input.LA(1);
	...
	public assemblyBlock(): AssemblyBlockContext {
		...
		try {
			...
			this._errHandler.sync(this);
			_la = this._input.LA(1);
			while ((((_la) & ~0x1F) === 0 && ((1 << _la) & 679526400) !== 0) || ((((_la - 40)) & ~0x1F) === 0 && ((1 << (_la - 40)) & 287322177) !== 0) || ((((_la - 90)) & ~0x1F) === 0 && ((1 << (_la - 90)) & 1176879241) !== 0) || ((((_la - 127)) & ~0x1F) === 0 && ((1 << (_la - 127)) & 59) !== 0)) {
				{
				{
				this.state = 980;
				this.assemblyItem();
	...
	public assemblyCall(): AssemblyCallContext {
		...
		try {
			...
			case 1:
				...
				this._errHandler.sync(this);
				_la = this._input.LA(1);
				if (_la===14 || _la===27 || ((((_la - 46)) & ~0x1F) === 0 && ((1 << (_la - 46)) & 4489281) !== 0) || ((((_la - 97)) & ~0x1F) === 0 && ((1 << (_la - 97)) & 3230141313) !== 0) || ((((_la - 130)) & ~0x1F) === 0 && ((1 << (_la - 130)) & 7) !== 0)) {
					{
					this.state = 1023;
					this.assemblyExpression();
					}
	...
	1,0,76,77,1,0,7,10,1,0,36,37,2,0,11,11,80,89,1,0,105,106,10,0,14,14,27,

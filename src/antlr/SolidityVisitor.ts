...
export interface SolidityVisitor<Result> extends ParseTreeVisitor<Result> {
  ...
  visitStateVariableDeclaration?: (
    ctx: StateVariableDeclarationContext,
  ) => Result
   ...
   * @return the visitor result
   */
  visitFunctionTypeParameterList?: (
    ctx: FunctionTypeParameterListContext,
  ) => Result
   ...
   * @return the visitor result
   */
  visitInlineAssemblyStatementFlag?: (
    ctx: InlineAssemblyStatementFlagContext,
  ) => Result
   ...
   * @return the visitor result
   */
  visitAssemblyIdentifierOrList?: (
    ctx: AssemblyIdentifierOrListContext,
  ) => Result
   ...
   * @return the visitor result
   */
  visitAssemblyFunctionDefinition?: (
    ctx: AssemblyFunctionDefinitionContext,
  ) => Result
